...
export const captureCategoricalValues = pgTable(
  "capture_categorical_values",
  {
    captureCategoricalValuesId: bigserial("capture_categorical_values_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    captureCategoricalOptionId: bigint("capture_categorical_option_id", {
      mode: "number",
    })
      .notNull()
    ...
    updatedAt: timestamp("updated_at", { withTimezone: true, mode: "string" }),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    captureVariableId: bigint("capture_variable_id", { mode: "number" })
      .notNull()
  ...
  (table) => {
    return {
      idx18196CaptureCategoricalOptionId: index(
        "idx_18196_capture_categorical_option_id"
      ).on(table.captureCategoricalOptionId),
      idx18196CaptureCategoricalValuesCaptureVariableIdForeig: index(
        "idx_18196_capture_categorical_values_capture_variable_id_foreig"
...
export const captureCategoricalOptions = pgTable(
  "capture_categorical_options",
  {
    captureCategoricalOptionId: bigserial("capture_categorical_option_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
  ...
  (table) => {
    return {
      idx18189CaptureVariableId: index("idx_18189_capture_variable_id").on(
...
export const capture = pgTable(
  "capture",
  {
    captureId: bigserial("capture_id", { mode: "bigint" })
      .primaryKey()
      .notNull(),
    captureTime: varchar("capture_time", { length: 3 }).default(
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    netEffId: bigint("net_eff_id", { mode: "number" })
      .notNull()
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    banderId: bigint("bander_id", { mode: "number" })
      .notNull()
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    sppId: bigint("spp_id", { mode: "number" })
      .notNull()
...
export const effortTime = pgTable("effort_time", {
  effortTimeId: bigserial("effort_time_id", { mode: "bigint" })
    .primaryKey()
    .notNull(),
  description: text("description").notNull(),
  portugueseLabel: varchar("portuguese_label", { length: 45 }).notNull(),
...
export const netEffort = pgTable(
  "net_effort",
  {
    netEffId: bigserial("net_eff_id", { mode: "bigint" })
      .primaryKey()
      .notNull(),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    effortId: bigint("effort_id", { mode: "number" })
      .notNull()
      .references(() => effort.effortId),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    netId: bigint("net_id", { mode: "number" })
      .notNull()
    ...
    originalId: bigint("original_id", { mode: "number" }),
    updatedAt: timestamp("updated_at", { withTimezone: true, mode: "string" }),
    redeId: varchar("REDE.ID", { length: 2 }).default(
      sql`NULL::character varying`
    ),
  },
  (table) => {
...
export const captureFlag = pgTable(
  "capture_flag",
  {
...
export const effortVariableRegister = pgTable("effort_variable_register", {
  // You can use { mode: "bigint" } if numbers are exceeding js number limitations
  effortVariableId: bigint("effort_variable_id", { mode: "number" })
    .primaryKey()
    .notNull(),
  name: varchar("name", { length: 45 }).notNull(),
  description: text("description").notNull(),
...
export const netRegister = pgTable(
  "net_register",
  {
...
export const protocolRegister = pgTable("protocol_register", {
  protocolId: bigserial("protocol_id", { mode: "bigint" })
    .primaryKey()
    .notNull(),
...
export const protocolVars = pgTable(
  "protocol_vars",
  {
    protocolParamId: bigserial("protocol_param_id", { mode: "bigint" })
      .primaryKey()
      .notNull(),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    protocolId: bigint("protocol_id", { mode: "number" })
      .notNull()
  ...
  (table) => {
    return {
      ...
      idx18286VariableId: index("idx_18286_variable_id").on(
        table.captureVariableId
      ),
    };
  }
...
export const sequelizemeta = pgTable(
  "sequelizemeta",
  {
...
export const effort = pgTable(
  "effort",
  {
    effortId: bigserial("effort_id", { mode: "number" }).primaryKey().notNull(),
    dateEffort: timestamp("date_effort", {
      withTimezone: true,
      mode: "string",
    }).notNull(),
    notes: varchar("notes", { length: 250 }).notNull(),
...
export const effortCategoricalOptions = pgTable(
  "effort_categorical_options",
  {
    effortCategoricalOptionId: bigserial("effort_categorical_option_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
  ...
  (table) => {
    return {
      idx18227EffortVariableId: index("idx_18227_effort_variable_id").on(
...
export const captureContinuousValues = pgTable(
  "capture_continuous_values",
  {
    captureContinuousValuesId: bigserial("capture_continuous_values_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
  ...
  (table) => {
    return {
      idx18201CaptureContinuousValuesCaptureVariableIdForeign: index(
        "idx_18201_capture_continuous_values_capture_variable_id_foreign"
      ).on(table.captureVariableId),
...
export const effortCategoricalValues = pgTable(
  "effort_categorical_values",
  {
    effortCategoricalValueId: bigserial("effort_categorical_value_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    effortCategoricalOptionId: bigint("effort_categorical_option_id", {
      mode: "number",
    })
      .notNull()
    ...
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    effortTimeId: bigint("effort_time_id", { mode: "number" })
      .notNull()
  ...
  (table) => {
    return {
      idx18234EffortCategoricalOptionId: index(
        "idx_18234_effort_categorical_option_id"
      ).on(table.effortCategoricalOptionId),
      idx18234EffortCategoricalValuesEffortVariableIdForeign: index(
        "idx_18234_effort_categorical_values_effort_variable_id_foreign_"
      ).on(table.effortVariableId),
      idx18234EffortId: index("idx_18234_effort_id").on(table.effortId),
      idx18234EffortTimeId: index("idx_18234_effort_time_id").on(
        table.effortTimeId
      ),
    };
  }
...
export const effortContinuousValues = pgTable(
  "effort_continuous_values",
  {
    effortContinuousValueId: bigserial("effort_continuous_value_id", {
      mode: "bigint",
    })
      .primaryKey()
      .notNull(),
  ...
  (table) => {
    return {
      idx18239EffortContinuousValuesEffortVariableIdForeignI: index(
        "idx_18239_effort_continuous_values_effort_variable_id_foreign_i"
      ).on(table.effortVariableId),
      idx18239EffortId: index("idx_18239_effort_id").on(table.effortId),
      idx18239EffortTimeId: index("idx_18239_effort_time_id").on(
        table.effortTimeId
      ),
    };
  }
...
export const effortSummaries = pgTable(
  "effort_summaries",
  {
    effortSummaryId: bigserial("effort_summary_id", { mode: "bigint" })
      .primaryKey()
      .notNull(),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
    effortId: bigint("effort_id", { mode: "number" })
